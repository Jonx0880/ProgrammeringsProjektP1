...
// (in-package programmerings_projekt.srv)
...
class AddTwoIntsRequest {
  ...
  static datatype() {
    ...
    return 'programmerings_projekt/AddTwoIntsRequest';
  }
...
class AddTwoIntsResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'programmerings_projekt/AddTwoIntsResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'programmerings_projekt/AddTwoInts'; }
};
